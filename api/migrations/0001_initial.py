# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2017-05-28 04:40
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.PositiveSmallIntegerField(choices=[(1, 'Pending'), (2, 'Accepted'), (3, 'Rejected'), (4, 'Blocked')], default=1)),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(through='api.ConnectionRequest', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
